...
!function(e) {
    ...
    function m(e) {
        ...
        return function e(t, r) {
            for (var a = t.firstChild; a; a = a.nextSibling)
                ...
                r = e(a, r),
                b(a).match(/br|hr|img|input/) || n.push({
                    event: "stop",
                    offset: r,
                    node: a
                }));
    ...
    function k(e, t, i, r) {
        ...
        function s() {
            b += null != u.sL ? function() {
                ...
                r = u.lR.exec(p); r; )
                    ...
                    (e = n.k.hasOwnProperty(s) && n.k[s]) ? (m += e[1],
                    a += c(e[0], y(r[0]))) : a += y(r[0]),
                    t = u.lR.lastIndex,
                    r = u.lR.exec(p);
        ...
        var p = ""
          , m = 0;
        try {
            for (var f, g, _ = 0; u.t.lastIndex = _,
            f = u.t.exec(t); )
                g = a(t.substring(_, f.index), f[0]),
                _ = f.index + g;
            for (a(t.substr(_)),
            n = u; n.parent; n = n.parent)
                n.cN && (b += N);
            return {
                r: m,
                value: b,
    ...
    function s(e) {
        ...
        i = t.textContent,
        a = s ? k(s, i, !0) : x(i),
        (r = m(t)).length && ((n = document.createElementNS("http://www.w3.org/1999/xhtml", "div")).innerHTML = a.value,
